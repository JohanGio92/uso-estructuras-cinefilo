...
template<class T> class Lista {
    ...
    public:
        ...
        /*
         * post: indica si la Lista no tiene ningún elemento.
         */
        bool estaVacia();
         ...
         *       desplazando los elementos siguientes.
         *
         */
         ...
         *       desplezando los elementos siguientes para ocupar
         *       la posición removida.
         */
